    ...
    return (
        <Modal
            ...
            <Form  form={form} id="exportForm"  onFinish={onFinish} 
                layout="vertical">
                <Form.Item>
                    <Form.Item label="Customer name"  style={{ display: 'inline-block', width: 'calc(25% - 16px)', margin: '0 8px' }}
                        name='Name'>
                        <Input  />
                    </Form.Item>

                    <Form.Item label="Contact point"  style={{ display: 'inline-block', width: 'calc(25% - 16px)', margin: '0 8px' }}
                        name='ContactPoint'>
                        <Input />
                    </Form.Item>

                    <Form.Item label="Contract start date" style={{ display: 'inline-block', width: 'calc(25% - 16px)', margin: '0 8px'  }} 
                                name='StartDate'>
                        <DatePicker showTime  style={{  width: '100%' }}/>
                    </Form.Item>

                    <Form.Item label="Contract end date" style={{ display: 'inline-block', width: 'calc(25% - 16px)', margin: '0 8px' }}
                                name='EndDate'>
                        <DatePicker showTime style={{  width: '100%' }}/>
                    </Form.Item>
